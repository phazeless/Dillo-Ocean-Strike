...
public class GameManager_Manager : MonoBehaviour{
    ...
    public GameObject m_HighScoreNotification;
    ...
    void Start(){
        ...
        Vector3 t_Temp = Goal_Gameobject.m_Instance.transform.position;
        t_Temp.z = 100;
        t_Temp.x = Goal_Gameobject.m_Instance.transform.position.x-m_PerfectDist;

        m_PerfectIcon.transform.position = t_Temp;

        t_Temp.x = Goal_Gameobject.m_Instance.transform.position.x - m_GoodDist;

        m_GoodIcon.transform.position = t_Temp;

        t_Temp.x = Goal_Gameobject.m_Instance.transform.position.x - m_BadDist;

        m_BadIcon.transform.position = t_Temp;
    ...
    private void OnDrawGizmosSelected() {
        if (Goal_Gameobject.m_Instance != null) {
            Gizmos.color = Color.yellow;
            Gizmos.DrawWireSphere(Goal_Gameobject.m_Instance.transform.position, m_PerfectDist);
            Gizmos.color = Color.black;
            Gizmos.DrawWireSphere(Goal_Gameobject.m_Instance.transform.position, m_GoodDist);
            Gizmos.color = Color.blue;
            Gizmos.DrawWireSphere(Goal_Gameobject.m_Instance.transform.position, m_BadDist);
        }
    }
    ...
    public void f_CompareGoalAndPlayer() {
        ...
        if (m_GameState == e_GameState.Normal || m_GameState == e_GameState.AfterFever) {
            ...
            if (t_Distance < m_PerfectDist) {
                ...
                m_CurrCombo++;
                //PointText_Manager.m_Instance.f_SpawnPoint(15, m_TextprefabSpawn.transform.position);
                ...
                m_CurrCombo = 0;
                //PointText_Manager.m_Instance.f_SpawnPoint(5, m_TextprefabSpawn.transform.position);
